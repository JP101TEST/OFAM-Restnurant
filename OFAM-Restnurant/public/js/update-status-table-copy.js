$(document).ready(function () {
                    ...
                    .map(table => {
                        return `<!--<p>Table ID: ${table.table_id}, Name: ${table.status_tables}, ...</p>-->
                            <tr>
                                ...
                                <td>
                                <!--
                                <form class="status-form-Required" data-table-id-Required="${table.table_id}" action="/update/table/status1/${table.table_id}" method="post">
                                @csrf
                                <label>
    ...
    $('.status-form-Required').submit(function (event) {
        event.preventDefault()
